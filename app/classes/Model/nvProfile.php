...
class Model_nvProfile extends Core_Model
{
	...
	public function loadByCodeAndTestId($code, $id) {
		...
		if ($id) {
			...
			$query = 'SELECT * FROM ' . $this->_tableProfiles . ' WHERE test_id=' . $id . ' AND code="'. $code.'"';
	...
	public function loadByTestAndTypeId($testId, $typeId)
	{

		$result = false;

		if ($testId and $typeId) {

			$query = 'SELECT * FROM ' . $this->_tableProfiles . ' WHERE test_id=' . $testId . ' AND type=' . $typeId;
	...
	public function loadById($id)
	{
		...
		if ($id) {
			...
			$query = 'SELECT * FROM ' . $this->_tableProfiles . ' WHERE id=' . $id;
