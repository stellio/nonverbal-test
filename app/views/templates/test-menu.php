			...
			<nav class="navbar navbar-inverse navbar-embossed" role="navigation">
	            <div class="collapse navbar-collapse" id="navbar-collapse-01">
	              <ul class="nav navbar-nav navbar-left">
	              	<li><a class="ajax-call" href="admin.php?page=NV&module=nvTestParam&call=edit&id=<?=$id;?>">Общие</a></li>
			        ...
			        <li><a class="ajax-call" href="admin.php?page=NV&module=nvStatistic&test_id=<?=$id;?>">Статистика</a></li>
	               </ul>
	            </div><!-- /.navbar-collapse -->
	        </nav><!-- /navbar -->
		</div>
